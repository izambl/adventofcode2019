...
console.time('day09 phase 1');
const results = [];
while (true) {
  const result = run(amplificator);
...
console.log(results);
console.timeEnd('day09 phase 1');


console.time('day09 phase 2');
const results2 = [];
while (true) {
  const result = run(amplificator2);
  
  if (result.exitMode === 'final') {
    break;
  }
  results2.push(result.output);
}
console.log(results2);
console.timeEnd('day09 phase 2');
