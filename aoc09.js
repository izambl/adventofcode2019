function run(amplificator) {
  ...
  function op05(v1, v2) {
    amplificator.index = read(v1) !== 0 ? read(v2) : amplificator.index + 3;
  ...
  function execute(opcode) {
    ...
    console.log('execute', opcode, v1, v2, v3);
